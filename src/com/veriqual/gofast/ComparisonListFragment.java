 ...
 * interface.
 */
public class ComparisonListFragment extends ListFragment {
...
//				android.R.id.text1, DummyContent.ITEMS));
		...
		for (Comparison comparison : Utilities.getComparisonsList(ComparisonListFragment.this.getActivity()).getComparisons()) {
			comparisonlist.add(comparison.getName());
		}
		final ArrayAdapter<String> sessionAdapter = new ArrayAdapter<String>(
				ComparisonListFragment.this.getActivity(), android.R.layout.simple_list_item_1, comparisonlist);
//		setListAdapter(sessionAdapter);
		setListAdapter(new ArrayAdapter<String>(getActivity(),
		android.R.layout.simple_list_item_activated_1,
		android.R.id.text1, comparisonlist));
